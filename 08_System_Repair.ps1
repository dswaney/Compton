...
# Changes: v3.0 rebuilds SoftwareDistribution.bak* cleanup with resumable state tracking, capped parallel deletion, timeout-safe jobs, and orphan job cleanup for Task Scheduler windows.
