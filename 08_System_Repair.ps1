...
# Changes: v3.6 adds RPC diagnostics to separate local client/service failures from remote endpoint/network RPC failures, with grep-friendly RPC_* markers.
