...
# Changes: Option 13 updated from 08_System_Repair.ps1 v3.9; Option 19 now runs only Full System Update tasks instead of default post-deployment tasks.
# =====================================================================
...
# Updated from 08_System_Repair.ps1 v3.9 on 2026-05-26
# -----------------------------------------------------------------------------
...
function Main {
    do {
        ...
        switch ($selection) {
			...
			"19" {
				Clear-Host
				# Option 19 should only run the Full System Update workflow.
